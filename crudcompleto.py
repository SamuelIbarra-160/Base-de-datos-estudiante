...
tk.Label(ventana, text="Apellidos:", font=("Arial", 11)).grid(row=1, column=0, padx=10, pady=8, sticky="e")
entry_apellidos = tk.Entry(ventana, width=35, font=("Arial", 11))
entry_apellidos.grid(row=1, column=1, padx=10, pady=8, columnspan=2)


tk.Label(ventana, text="Correo:", font=("Arial", 11)).grid(row=2, column=0, padx=10, pady=8, sticky="e")
entry_correo = tk.Entry(ventana, width=35, font=("Arial", 11))
entry_correo.grid(row=2, column=1, padx=10, pady=8, columnspan=2)


tk.Label(ventana, text="Telefono:", font=("Arial", 11)).grid(row=3, column=0, padx=10, pady=8, sticky="e")
entry_telefono = tk.Entry(ventana, width=35, font=("Arial", 11))
entry_telefono.grid(row=3, column=1, padx=10, pady=8, columnspan=2)


tk.Label(ventana, text="Carrera:", font=("Arial", 11)).grid(row=4, column=0, padx=10, pady=8, sticky="e")
entry_carrera = tk.Entry(ventana, width=35, font=("Arial", 11))
entry_carrera.grid(row=4, column=1, padx=10, pady=8, columnspan=2)


tk.Label(ventana, text="Nota:", font=("Arial", 11)).grid(row=5, column=0, padx=10, pady=8, sticky="e")
entry_nota = tk.Entry(ventana, width=15, font=("Arial", 11))
entry_nota.grid(row=5, column=1, padx=10, pady=8, sticky="w")

# ── BOTONES ────────────────────────────────────
frame_btns = tk.Frame(ventana)
frame_btns.grid(row=6, column=0, columnspan=3, pady=10)

tk.Button(frame_btns, text="➕ Agregar", bg="#2d6a4f", fg="white", command=agregar, width=12).grid(row=0, column=0, padx=5)
tk.Button(frame_btns, text="✏️ Editar", bg="#1d3557", fg="white", command=editar, width=12).grid(row=0, column=1, padx=5)
tk.Button(frame_btns, text="🗑️ Eliminar", bg="#9e2a2b", fg="white", command=eliminar, width=12).grid(row=0, column=2, padx=5)
tk.Button(frame_btns, text="🔄 Actualizar", bg="#555", fg="white", command=leer, width=12).grid(row=0, column=3, padx=5)

# ── TABLA (TREEVIEW) ───────────────────────────
cols = ("ID", "Nombre","Apellidos","Correo","Telefono", "Carrera", "Nota")
